...
var sscal = tryRequire( resolve( __dirname, './../lib/sscal.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 4', opts, function test( t ) {
	t.strictEqual( sscal.length, 4, 'returns expected value' );
	t.end();
});
